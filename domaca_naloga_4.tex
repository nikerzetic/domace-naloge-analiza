...
\item[(18)] Naj bo $n \in \NN, n \geq 2$. Pokaži, da je $(1 + \cos \frac{1}{n} + i \sin \frac{1}{n})^n$ imaginarno število. (Nasvet: Izračunaj argument)

Poskusimo upoštevati nasvet in izračunajmo argument tega števila. Najprej izračunajmo argument kompleksnega števila v oklepajih:
\[
\arg \left(1+ \cos \frac{\pi}{n} + i \sin \frac{\pi}{n} \right) = \arctan \frac{\sin \frac{\pi}{n}}{1 + \cos \frac{\pi}{n}}
\]
Ulomek želimo nekako poenostaviti. Poskusimo razbiti $\sin \frac{\pi}{n}$ in $\cos \frac{\pi}{n}$ na polovična kota.
\[
\frac{2 \sin \frac{\pi}{2n} \cos \frac{\pi}{2n}}{(\sin^2 \frac{\pi}{2n} + \cos^2 \frac{\pi}{2n}) + \cos^2 \frac{\pi}{2n} - \sin^2 \frac{\pi}{2n}} = 
\frac{2 \sin \frac{\pi}{2n} \cos \frac{\pi}{2n}}{2\cos^2 \frac{\pi}{2n}} = 
\frac{\sin \frac{\pi}{2n}}{\cos \frac{\pi}{2n}} = 
\tan \frac{n\pi}{2n}
\]
No, to izgleda precej bolje. Sedaj pa izračunajmo argument tega števila:
\[
\arg \left(1+ \cos \frac{1}{n} + i \sin \frac{1}{n} \right)^n = \arctan \tan \frac{n}{2n} = \arctan \tan \frac{\pi}{2} = \frac{pi}{2}
\]
Če je argument nekega kompleksnega števila enak $\frac{pi}{2}$, to pomeni, da to število leži na pozitivnem delu imaginarne osi. To pomeni, da je to število imaginarno.
